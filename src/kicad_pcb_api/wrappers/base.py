"""Base wrapper class for PCB elements."""
...
class ElementWrapper(ABC, Generic[T]):
    """Base class for all PCB element wrappers.
    ...
    def __init__(self, data: T, parent_collection: "IndexedCollection[Any]"):
        """Initialize the wrapper.

        Args:
            data: The underlying dataclass instance
            parent_collection: The collection this element belongs to
        """
        self._data = data
